  ...
  return (
    <div className='fixed top-0 h-screen left-0 w-full bg-black/40 flex items-center justify-center z-10'>
        <div ref={togref} className="bg-white px-4 py-10 rounded-lg w-11/12 max-w-xl relative modalbefore">
            <div className="font-light flex items-center justify-center gap-2"> <span className="font-bold">Hi {profile.username}, </span> Do you want to store this passenger details for future use?</div>
            <div className="mt-10">
