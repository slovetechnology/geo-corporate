            ...
            <div className="w-full">
                ...
                <div className="">
                    <div className="flex items-center justify-center gap-5">
                        <div className="tts text-center text-3xl capitalize">Password Changed </div>
                    </div>
                    ...
                    <div className="mt-12">
                        <button onClick={() => navigate('/')} className='btn w-full h-[3.1rem] text-white rounded-lg tts'>Login</button>
                    </div>
                </div>
            </div>
        </FormPage>
