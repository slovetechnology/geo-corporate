    ...
    return (
        <SettingsLayout>
            ...
            <div className="w-11/12 bg-white border">
                ...
                <div className="w-11/12 py-8 ml-auto">
                    <div className="flex items-center justify-between p-3 mb-4 border rounded-lg lg:w-4/6 bg-sky-50">
                    ...
                    <div onClick={() => setView(!view)} className="flex items-center justify-between p-3 mb-4 bg-white border rounded-lg cursor-pointer lg:w-4/6">
                        <div className="">
